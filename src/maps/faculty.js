...
instructions(coordinates) {
 ...
 handleMarkerClick(markerIndex) {
  ...
  render() {
    ...
    <circle cx = { this.projection()([-86.9081,40.4259])[0] } cy ={ this.projection()([-86.9081,40.4259])[1] } r = "2%" fill = "url(#test)">
     <title className = "tooltip" >Purdue Polytechnic Institute</title>
        ...
        <form  >
          <input id = "facultySlider" type="range" name="foo1" min="2015" max="2018"  onChange = {this.test}></input>
